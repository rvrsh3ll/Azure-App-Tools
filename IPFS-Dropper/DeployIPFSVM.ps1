...
Write-Output "az vm create --resource-group $ResourceGroup --name webinar --image Ubuntu2204 --public-ip-sku Standard --public-ip-address-dns-name bhistokenwebinar --admin-username azureuser --ssh-key-values $pubKey"
