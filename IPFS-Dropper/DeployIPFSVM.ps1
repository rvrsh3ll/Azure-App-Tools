...
Start-Sleep -Seconds 5
Write-Output "az vm run-command invoke -g $ResourceGroup -n $vmName --command-id RunShellScript --scripts '/usr/bin/tar -xvzf /home/azureuser/kubo.tar.gz -C /home/azureuser'"
az vm run-command invoke -g $ResourceGroup -n $vmName --command-id RunShellScript --scripts '/usr/bin/tar -xvzf /home/azureuser/kubo.tar.gz -C /home/azureuser'
Start-Sleep -Seconds 5
